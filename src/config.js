...
const SONAR_SCANNER_CLI_ZIP = `sonar-scanner-cli-${SONAR_SCANNER_CLI_VERSION}.zip`;
const SONAR_SCANNER_URL = `${SONAR_SCANNER_BASE_URL}/${SONAR_SCANNER_CLI_ZIP}`;
...
const config = {
  ...
  sonarqubeScannerZip: SONAR_SCANNER_CLI_ZIP,
